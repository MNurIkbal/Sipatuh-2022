...
<div class="main-content">
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="<?= base_url("tambah_petugas_baru");  ?>" >
                ...
                <a href="<?= base_url("detail_realisasi/" .$id_kloter . '/' . $result['id']);  ?>" class="btn btn-warning">Kembali</a>
