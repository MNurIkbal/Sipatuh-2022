                                ...
                                <tbody>
                                    <?php $no = 1; foreach($result as $row) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- <a href="<?=  base_url("detail_realisasi/$row[id]");  ?>"   class="btn btn-primary"><i class="fa fa-newspaper"></i></a> -->
                                                <a href="<?=  base_url("detail_realisasi_kloter/$row[id]");  ?>"   class="btn btn-primary"><i class="fa fa-newspaper"></i></a>
                                            </td>
                                        </tr>
