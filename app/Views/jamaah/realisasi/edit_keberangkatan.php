...
<div class="main-content">
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="<?= base_url("edit_keberangkatan_real");  ?>" >
                    ...
                    <div >
                        ...
                        <a href="<?= base_url('detail_realisasi/' . $id_kloters . '/' . $result['id']); ?>"  class="btn btn-dark" >Kembali</a>
