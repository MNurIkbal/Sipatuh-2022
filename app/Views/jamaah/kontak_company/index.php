                                ...
                                <tbody>
                                    ...
                                    foreach ($slider as $gg) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#main<?= $gg->id ?>"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<?php foreach($slider as $rw) : ?>
    <div class="modal fade" tabindex="-1" role="dialog" id="main<?= $rw->id ?>">
        <div class="modal-dialog modal-lg" role="document">
            <form method="POST" action="<?= base_url("hapus_slider");  ?>" enctype="multipart/form-data" class="modal-content">
