                                ...
                                <tbody>
                                    <?php $no = 1; foreach($result as $row) : ?>
                                        ...
                                        <?=  date("D, d F Y",strtotime($row["tgl_berangkat"])) . " - " . date("D, d F Y",strtotime($row["tgl_pulang"]))  ;  ?>
                                            ...
                                            <td>
                                                <span>BELUM BAYAR : <?=  count($belum_bayar);  ?> ORANG</span>
                                                <br>
                                                <span>BELUM LUNAS : <?=  count($setor_awal);  ?> ORANG</span>
                                                <br>
                                                <span>LUNAS : <?=  count($lunas);  ?> ORANG</span>
                                            </td>
                                            <td>
                                                <span>
                                                PASPOR : <?=  count($paspor);  ?> ORANG
                                                </span>
                                                <br>
                                                <span>
                                                    VISA : <?=  count($visa);  ?> ORANG
                                                </span>
                                                <br>
                                                <span>
                                                    POLIS : <?=  count($asuransi);  ?> ORANG
                                                </span>
                                            </td>
                                            <td>
                                                <?php if(count($pendaftaran)) : ?>
                                                    <?php if($row['pemberangkatan'] == "sudah") :  ?>
                                                        ...
                                                        <?php else: ?>
                                                        <span class="badge badge-pill badge-warning">Ada Jamaah</span>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                            ...
                                            <td>
                                                <!-- <a href="#"   class="btn btn-primary"><i class="fa fa-clipboard"></i></a> -->
                                                <!-- <a title="Detail" href="<?= base_url("tambah_pendaftaran/" . $row['id']) ?>" class="btn btn-success" ><i class="fa fa-user-plus"></i></a> -->
                                                <a title="Detail" href="<?=  base_url("detail_pendaftaran_kloter/$row[id]");  ?>"
