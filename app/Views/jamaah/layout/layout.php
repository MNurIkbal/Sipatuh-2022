...
<body>
 ...
 if(session()->get("level_id") == "jamaah") : ?>
          ...
          <li class="dropdown ">
            ...
            <li class="dropdown ">
              <a href="#" class="nav-link has-dropdown <?= (isset($title) && $title == "Pengaturan" || $title == "Layanan" || $title == "Testimoni" || $title == "Contact") ? "bg-success" : ""; ?> text-white sy"><i class="fa  fa-home"></i> <span>Company Profile</span></a>
              <ul class="dropdown-menu">
