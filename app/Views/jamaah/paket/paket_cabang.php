                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($row['status_paket_cabang'] == "sudah" ) : ?>
                                                <a title="Detail" href="<?=  base_url("detail_paket/$row[id]");  ?>"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="uang" class="form-control" required placeholder="Biaya   "
                                name="biaya">
                        </div>
                        
                        <div class="mb-3">
                            <label for="">Waktu Berangkat</label>
                            <input type="date" class="form-control" required placeholder="Biaya   "
                                name="waktu_berangkat" id="berangkat">
                        </div>
                        <div class="mb-3">
                            <label for="">Keterangan Berangkat</label>
                            <textarea name="ket_berangkat" class="form-control" id="" cols="30" rows="10"
                                placeholder="Keterangan Berangkat"></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col d-flex">
                                <label class="colorinput">
                                    <input id="aktif" name="status" value="aktif" type="checkbox" value="danger"
                                        class="colorinput-input" />
                                    <span class="colorinput-color bg-primary"></span>
                                </label>
                                <label for="aktif"
                                    style="transform: translateY(0px) !important;transform: translateX(10px) !important;">Aktif</span>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="">Keterangan Pulang</label>
                            <textarea name="ket_pulang" class="form-control" id="" cols="30" rows="10"
                                placeholder="Keterangan Pulang"></textarea>
                        </div>
                        <div class="mb-3">
...
<div class="modal fade" tabindex="-1" role="dialog" id="hapus<?= $main['id'] ?>">
    <div class="modal-dialog modal-lg" role="document">
        <form method="POST" enctype="multipart/form-data" action="<?=  base_url("hapus_paket/" . $main['id']);  ?>"
            class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="">Biaya</label>
                            <input type="text" id="uang_baru" class="form-control" required placeholder="Biaya   "
                                name="biaya" value="<?=  $main['biaya'];  ?>">
                        </div>
                        <div class="mb-3">
                            <label for="">Waktu Berangkat</label>
                            <input type="date" class="form-control" required placeholder="Biaya   "
                                name="waktu_berangkat" value="<?=  $main['tgl_berangkat'];  ?>">
                        </div>
                        <div class="mb-3">
                            <label for="">Keterangan Berangkat</label>
                            <textarea name="ket_berangkat" class="form-control" id="" cols="30" rows="10"
                                placeholder="Keterangan Berangkat"><?=  $main['ket_berangkat'];  ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="">Provider</label>
                            <br>
                            <select name="provider" class="form-control select1<?= $main['id'] ?>" style="width: 100% !important;" required id="">
                                ...
                                <option <?=  ($mains['nama_provider'] == $main['provider']) ? "selected" : "";  ?>
                                    value="<?=  $mains['nama_provider'];  ?>"><?=  $mains['nama_provider'];  ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" required placeholder="" name="waktu_pulang"
                                value="<?=  $main['tgl_pulang'];  ?>">
                        </div>
                        <div class="mb-3">
                            <label for="">Status</label>
                            <div class="col d-flex">
                                <label class="colorinput">
                                    <input id="aktif" name="status" value="aktif" type="checkbox"
                                        <?=  ($main['status'] == "aktif") ? "checked" : "";  ?> value="danger"
                                        class="colorinput-input" />
                                    <span class="colorinput-color bg-primary"></span>
                                </label>
                                <label for="aktif"
                        ...
                        <div class="mb-3">
                            <label for="">Keterangan Pulang</label>
                            <textarea name="ket_pulang" class="form-control" id="" cols="30" rows="10"
                                placeholder="Keterangan Pulang"><?=  $main['ket_pulang'];  ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="">Asuransi</label>
                            <br>
