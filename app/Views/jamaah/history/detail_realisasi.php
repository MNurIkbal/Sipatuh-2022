    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4>Detail History Realisasi Paket</h6>
                            <div class="row">
                                <div class="col-md-6">
                                    <ul>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($kasus as $kasuss) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= base_url("laporan_harian_realisasi/" . $kasuss['id'] . '/' . $id_paket . '/' . $id_kloter . '/' . $judul);  ?>" class="btn btn-primary"><i class="fa fa-newspaper"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
