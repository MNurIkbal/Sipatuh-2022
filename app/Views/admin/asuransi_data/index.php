                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="myTable">
                                ...
                                <tbody>
                                    <?php $no = 1; foreach($asuransi as $row) :?>
                                        <tr>
                                            <td><?=  $no++;  ?></td>
                                    <td>
                                        <?=  $row['nama'];  ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="tambah">
    <div class="modal-dialog modal-lg" role="document">
        <form method="POST" enctype="multipart/form-data" action="<?=  base_url("add_asuransi");  ?>"
            class="modal-content">
...
<?php foreach($asuransi as $main) : ?>
    <div class="modal fade" tabindex="-1" role="dialog" id="hapus<?= $main['id'] ?>">
    <div class="modal-dialog modal-lg" role="document">
        <form method="POST" enctype="multipart/form-data" action="<?=  base_url("hapus_asuransi_data/$main[id]");  ?>"
            class="modal-content">
            <div class="modal-header">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <form method="POST" enctype="multipart/form-data" action="<?=  base_url("edit_asuransi_data/$main[id]");  ?>"
            class="modal-content">
            <div class="modal-header">
