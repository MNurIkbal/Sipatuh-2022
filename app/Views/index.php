                ...
                <div class="col-md-6 col-12">
                  <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col-md-7 p-4 d-flex flex-column position-static">
                      ...
                      <small class="mb-2"><i class="fas fa-globe" style="padding-right: 5px"></i> <a href="<?= base_url($profile['website']); ?>" target="_blank" style="color: black;text-decoration: none;"><?= $profile['website']; ?></a></small>
