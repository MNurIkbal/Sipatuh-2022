...
class KepulanganController extends BaseController
{
    ...
    public function tambah_kepulangan_satu()
    {
        if(!session()->get("login") || session()->get("login") == null) {
            return redirect()->to("/");
            exit;
        ...
        try {
            ...
            return redirect()->to("detail_realisasi/" . $id_kloter . '/' . $this->request->getVar("id"))->with("success","Data Berhasil Ditambahkan");
        } catch (\Throwable $th) {
            return redirect()->to("detail_realisasi/" . $id_kloter . '/' . $this->request->getVar("id"))->with("error","Data Gagal Ditambahkan");
            //throw $th;
        }
    }
    ...
    public function edit_kepulangan_satu()
    {
        if(!session()->get("login") || session()->get("login") == null) {
            return redirect()->to("/");
            exit;
        ...
        return redirect()->to("detail_realisasi/" . $id_kloter  . '/' . $this->request->getVar("id_paket"))->with("success","Data Berhasil Diupdate");
    }
