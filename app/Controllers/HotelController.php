...
class HotelController extends BaseController
{
    ...
    public function tambah_hotel_real()
    {
        if(!session()->get("login") || session()->get("login") == null) {
            return redirect()->to("/");
            exit;
    ...
    public function edit_hotel_satu()
    {
        if(!session()->get("login") || session()->get("login") == null) {
            return redirect()->to("/");
            exit;
        ...
        try {
            ...
            return redirect()->to("detail_realisasi/" . $id_kloter . '/' . $this->request->getVar("id_paket"))->with("error","Data Gagal Diupdate");
            //throw $th;
        }
    }
